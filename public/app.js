...
},{"./gsap-core.js":2}],2:[function(require,module,exports){
"use strict";
...
},{"./CSSPlugin.js":1,"./gsap-core.js":2}],4:[function(require,module,exports){
"use strict";
...
},{"./internal/index.mjs":5}],5:[function(require,module,exports){
...
const { SvelteComponent, append, attr, binding_callbacks, detach, element, empty, init, insert, listen, noop, run_all, safe_not_equal, space } = require("svelte/internal");
const { onMount } = require("svelte");
const { default: gsap } = require("gsap");

function add_css() {
	var style = element("style");
	style.id = "svelte-10z2via-style";
	style.textContent = ".svelte-10z2via.svelte-10z2via{box-sizing:border-box}.chrome.svelte-10z2via.svelte-10z2via{display:grid;grid-template-columns:300px 1fr 300px;grid-template-areas:\"l h r\"\r\n            \"l c r\"\r\n            \"f f f\"}.chrome.svelte-10z2via .header.svelte-10z2via{grid-area:h;margin:0 auto;width:600px;padding:16px}.chrome.svelte-10z2via .left-sidebar.svelte-10z2via{grid-area:l}.chrome.svelte-10z2via .canvas.svelte-10z2via{grid-area:c;border:1px solid black}.box.svelte-10z2via.svelte-10z2via{display:inline-block;width:64px;height:32px;color:white;position:absolute;text-align:center}.up.box.svelte-10z2via.svelte-10z2via{background:blue}.right.box.svelte-10z2via.svelte-10z2via{background:rgb(145, 145, 100)}.down.box.svelte-10z2via.svelte-10z2via{background:green}.left.box.svelte-10z2via.svelte-10z2via{background:red}.goal.box.svelte-10z2via.svelte-10z2via{background:none;border:1px dotted black;color:black;z-index:-1}.win.svelte-10z2via.svelte-10z2via{display:inline-block;position:absolute;max-height:320px;background:rgb(145, 145, 100);padding:32px;color:white;font-size:32px}.canvas.svelte-10z2via.svelte-10z2via{position:relative;margin:0 auto;width:600px;height:600px;border:1px solid black}";
...
function create_if_block(ctx) {
	...
	return {
		c() {
			div1 = element("div");
			div0 = element("div");
			div0.textContent = "You win!";
			t1 = space();
			button = element("button");
			button.textContent = "Play again?";
			attr(div0, "class", "svelte-10z2via");
			attr(button, "class", "play-again svelte-10z2via");
			attr(div1, "class", "win svelte-10z2via");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*won*/ ctx[0] && create_if_block(ctx);
	...
	return {
		c() {
			...
			t2 = space();
			p0 = element("p");
			p0.textContent = "A point and drag game";
			t4 = space();
			div8 = element("div");
			div0 = element("div");
			div0.textContent = `Level ${level}`;
			t7 = space();
			div1 = element("div");

			div1.innerHTML = `<p class="svelte-10z2via"><i class="svelte-10z2via">Up</i> is a game best played with a desktop mouse.</p> 
        <p class="svelte-10z2via">There is a collection of boxes in the center of the playing area.</p> 
        <p class="svelte-10z2via">Your goal is to move to box labelled &quot;up&quot; into the goal area.</p>`;
			...
			t22 = space();
			div6 = element("div");
			div6.textContent = "goal";
			t24 = space();
			if (if_block) if_block.c();
			if_block_anchor = empty();
			document.title = "Up - Can you go up?";
			attr(h1, "class", "svelte-10z2via");
			attr(p0, "class", "svelte-10z2via");
			attr(div0, "class", "header svelte-10z2via");
			attr(div1, "class", "left-sidebar svelte-10z2via");
			attr(div2, "class", "up box svelte-10z2via");
			attr(div3, "class", "right box svelte-10z2via");
			attr(div4, "class", "down box svelte-10z2via");
			attr(div5, "class", "left box svelte-10z2via");
			attr(div6, "class", "goal box svelte-10z2via");
			attr(div7, "class", "canvas svelte-10z2via");
			attr(div8, "class", "chrome svelte-10z2via");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div2, "mouseenter", /*moveUp*/ ctx[2]),
					listen(div2, "mouseleave", /*reverseUp*/ ctx[3]),
					listen(div3, "mouseenter", /*moveRight*/ ctx[4]),
					listen(div3, "mouseleave", /*reverseRight*/ ctx[5]),
					listen(div4, "mouseenter", /*moveDown*/ ctx[6]),
					listen(div4, "mouseleave", /*reverseDown*/ ctx[7]),
					listen(div5, "mouseenter", /*moveLeft*/ ctx[8]),
					listen(div5, "mouseleave", /*reverseLeft*/ ctx[9])
				];
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(() => {
		...
		gsap.to(".up.box,.left.box,.down.box,.right.box", { x: 300 - 32, y: 300 - 32 });

		// up
		upTween = gsap.timeline({
			onComplete: () => {
				$$invalidate(0, won = true);
			}, // gsap.to(".win", {
	...
	function div6_binding($$value) {
		binding_callbacks[$$value ? "unshift" : "push"](() => {
			goalRef = $$value;
			$$invalidate(1, goalRef);
		});
	}

	const click_handler = e => {
		resetPositions();
		$$invalidate(0, won = false);
	};
...
class App extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-10z2via-style")) add_css();
...
},{"gsap":3,"svelte":4,"svelte/internal":5}],7:[function(require,module,exports){
"use strict";
